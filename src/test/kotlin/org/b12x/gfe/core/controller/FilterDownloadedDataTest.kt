...
class FilterDownloadedDataTest {
    ...
    fun scanForDuplicates_returnListOfDuplicates() {
        ...
        val hlaDuplicates = listOf(
            ...
            listOf("HLA-DRB1w0-0-0-16-0-0-0-0-0-0-0-0-0","HLA-DRB1*01:01:03"),
            listOf("HLA-DRB1w5-5-336-296-1324-20-20-1-3-1-4-1-5","HLA-DRB1*04:01:01:01"),
            listOf("HLA-DRB1w5-5-336-296-1325-20-20-1-3-1-36-1-5","HLA-DRB1*04:01:01:01")
        )
        val kirDuplicates = listOf(
            listOf("KIR2DL4w4-4-4-4-12-11-9-0-0-4-19-8-6-6-3-16-1-2-3", "KIR2DL4*0010201"),
    ...
    companion object {
        ...
        fun createTempDataFiles() {
            ...
            val hlaRows = listOf(
                ...
                listOf("HLA-DRB3w0-0-0-297-0-0-0-0-0-0-0-0-0","HLA-DRB3*04:01:02"),
                listOf("HLA-DRB3w0-0-0-298-0-0-0-0-0-0-0-0-0","HLA-DRB3*04:01:03"),
                listOf("HLA-DRB3w0-0-0-299-0-0-0-0-0-0-0-0-0","HLA-DRB3*04:01:04")
            )
